 ...
 */
@Schema(description = "Objeto que contiene la información del punto de venta que se registro.")
...
public class SalesPointRespose {
  ...
  **/
   ...
   * @return userKey
  **/
  @Schema(description = "Llave de usuario para el API Wire4")
   ...
   * @return userSecret
  **/
  @Schema(description = "Contraseña para el API Wire4")
