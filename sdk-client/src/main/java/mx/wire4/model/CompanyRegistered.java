...
public class CompanyRegistered {
   ...
   * @return businessName
  **/
  @Schema(description = "Nombre de la empresa registrada")
   ...
   * @return certificate
  **/
  @Schema(description = "La información del certificado")
  ...
  **/
  @Schema(description = "Nombre comercial de la empresa registrada")
  ...
  **/
   ...
   * @return rfc
  **/
  @Schema(description = "RFC de la empresa registrada")
   ...
   * @return status
  **/
  @Schema(description = "El estado de la compañía")
