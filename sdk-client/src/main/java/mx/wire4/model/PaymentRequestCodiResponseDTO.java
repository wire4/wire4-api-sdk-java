...
public class PaymentRequestCodiResponseDTO {
   ...
   * @return amount
  **/
  @Schema(description = "Es el Monto del pago. Ejemplo 1000.00")
  ...
  **/
  @Schema(description = "Es la imagen QR en formato Base64 para el CODI®.")
   ...
   * @return barcodeUrl
  **/
  @Schema(description = "Es la dirección URL de la imagen QR para el CODI®.")
  ...
  **/
   ...
   * @return creationDate
  **/
  @Schema(description = "Es la fecha de creación. Ésta fecha viene en formato ISO 8601 con zona horaria, ejemplo: <strong>2020-10-27T11:03:15.000-06:00</strong>.")
   ...
   * @return dueDate
  **/
  @Schema(description = "Es la fecha de vencimiento. Ésta fecha viene en formato ISO 8601 con zona horaria, ejemplo: <strong>2020-10-27T11:03:15.000-06:00</strong>.")
   ...
   * @return operations
  **/
  @Schema(description = "Es el listado de pagos realizados sobre la petición.")
   ...
   * @return orderId
  **/
  @Schema(description = "Es el orderId asignado a la solicitud.")
  ...
  **/
   ...
   * @return status
  **/
  @Schema(description = "Es el estado (estatus) de la orden de pago. Los valores pueden ser: <b>RECEIVED, COMPLETED Y CANCELLED</b>")
   ...
   * @return type
  **/
  @Schema(description = "Es el tipo de petición. Los valores pueden ser: <b>QR_CODE o PUSH_NOTIFICATION</b>")
