 ...
 */
@Schema(description = "Certificado de la empresa que se esta registrando")
...
public class CertificateRequest {
   ...
   * @return alias
  **/
  @Schema(description = "Alias del certificado")
  ...
  **/
  @Schema(description = "Numero de certificado")
   ...
   * @return checkDigit
  **/
  @Schema(description = "Dígito verificador")
   ...
   * @return cipherData
  **/
  @Schema(description = "Información de cifrado")
