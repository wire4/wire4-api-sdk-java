...
public class MessageWebHook {
  ...
  **/
   ...
   * @return data
  **/
  @Schema(description = "Objeto que contiene la información del evento")
   ...
   * @return id
  **/
  @Schema(description = "El identificador del mensaje")
  public String getId() {
    return id;
  }
  ...
  **/
  @Schema(description = "Número de  mensajes pendientes de enviar")
   ...
   * @return request
  **/
  @Schema(description = "Identificador del recurso relacionado")
   ...
   * @return type
  **/
  @Schema(description = "El tipo evento que se esta enviando en la notifiación")
