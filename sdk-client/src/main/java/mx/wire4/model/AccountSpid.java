...
public class AccountSpid {
  ...
  **/
  @Schema(required = true, description = "Tipo de relación de la cuentaobtained of endpoint relationships")
  ...
  **/
   ...
   * @return relationship
  **/
  @Schema(required = true, description = "Código de relación de la cuenta, este valor debe ser igual a un valor obtenido del endpoint relationship")
