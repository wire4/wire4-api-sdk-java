...
public class OperacionesCoDiApi {
    ...
    /**
     * Build call for consultCodiOperations
     * @param authorization Header para token (required)
     * @param body Filtros de busqueda (optional)
     * @param companyId Identificador de empresa CoDi (optional)
     * @param page Número de pago (optional)
     * @param salesPointId Identificador del punto de venta (optional)
     * @param size Tamaño de pagina (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call consultCodiOperationsCall(String authorization, CodiOperationsFiltersRequestDTO body, String companyId, String page, String salesPointId, String size, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/codi/charges";
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("sales_point_id", salesPointId));
        if (size != null)
    ...
    private com.squareup.okhttp.Call consultCodiOperationsValidateBeforeCall(String authorization, CodiOperationsFiltersRequestDTO body, String companyId, String page, String salesPointId, String size, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling consultCodiOperations(Async)");
        }
        
        com.squareup.okhttp.Call call = consultCodiOperationsCall(authorization, body, companyId, page, salesPointId, size, progressListener, progressRequestListener);
        return call;
     ...
     */
    public PagerResponseDto consultCodiOperations(String authorization, CodiOperationsFiltersRequestDTO body, String companyId, String page, String salesPointId, String size) throws ApiException {
        ApiResponse<PagerResponseDto> resp = consultCodiOperationsWithHttpInfo(authorization, body, companyId, page, salesPointId, size);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PagerResponseDto> consultCodiOperationsWithHttpInfo(String authorization, CodiOperationsFiltersRequestDTO body, String companyId, String page, String salesPointId, String size) throws ApiException {
        com.squareup.okhttp.Call call = consultCodiOperationsValidateBeforeCall(authorization, body, companyId, page, salesPointId, size, null, null);
        Type localVarReturnType = new TypeToken<PagerResponseDto>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Obtiene las operaciones generadas a partir de peticiones de pago CoDi® de forma paginada, pudiendo aplicar filtros (asynchronously)
     * Obtiene las operaciones generadas a partir de peticiones de pago CoDi® de forma paginada, pudiendo aplicar filtros
     * @param authorization Header para token (required)
     * @param body Filtros de busqueda (optional)
     * @param companyId Identificador de empresa CoDi (optional)
     ...
     */
    public com.squareup.okhttp.Call consultCodiOperationsAsync(String authorization, CodiOperationsFiltersRequestDTO body, String companyId, String page, String salesPointId, String size, final ApiCallback<PagerResponseDto> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = consultCodiOperationsValidateBeforeCall(authorization, body, companyId, page, salesPointId, size, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PagerResponseDto>(){}.getType();
