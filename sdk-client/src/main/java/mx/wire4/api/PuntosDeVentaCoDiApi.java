...
public class PuntosDeVentaCoDiApi {
     ...
     * @param body Es el objeto que contiene información del punto de venta CODI®. (required)
     * @param authorization Header para token (required)
     * @param companyId Es el identificador de la empresa. (required)
    ...
    /**
     * Registro de punto de venta. (asynchronously)
     * Se registra un punto de venta (TPV) desde donde se emitarán los cobros CODI®. El punto de venta se debe asociar a un cuenta CLABE registrada previamente ante Banxico para realizar cobros con CODI®.
     * @param body Es el objeto que contiene información del punto de venta CODI®. (required)
     * @param authorization Header para token (required)
     * @param companyId Es el identificador de la empresa. (required)
     ...
     * @param authorization Header para token (required)
     * @param companyId Es el identificador de la empresa. Ejemplo: 8838d513-5916-4662-bb30-2448f0f543ed (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Consulta de puntos de venta (asynchronously)
     * Obtiene los puntos de venta asociados a una empresa en las cuales se hacen operaciones CODI®.
     * @param authorization Header para token (required)
     * @param companyId Es el identificador de la empresa. Ejemplo: 8838d513-5916-4662-bb30-2448f0f543ed (required)
     * @param callback The callback to be executed when the API call finishes
