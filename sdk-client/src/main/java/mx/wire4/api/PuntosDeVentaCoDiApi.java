...
public class PuntosDeVentaCoDiApi {
     ...
     * @param body salesPointRequest (required)
     ...
     */
    public com.squareup.okhttp.Call createSalesPointCall(SalesPointRequest body, String authorization, String companyId, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/codi/companies/{company_id}/salespoint"
    ...
    private com.squareup.okhttp.Call createSalesPointValidateBeforeCall(SalesPointRequest body, String authorization, String companyId, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createSalesPointCall(body, authorization, companyId, name, progressListener, progressRequestListener);
        return call;
     ...
     */
    public SalesPointRespose createSalesPoint(SalesPointRequest body, String authorization, String companyId, String name) throws ApiException {
        ApiResponse<SalesPointRespose> resp = createSalesPointWithHttpInfo(body, authorization, companyId, name);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<SalesPointRespose> createSalesPointWithHttpInfo(SalesPointRequest body, String authorization, String companyId, String name) throws ApiException {
        com.squareup.okhttp.Call call = createSalesPointValidateBeforeCall(body, authorization, companyId, name, null, null);
     ...
     */
    public com.squareup.okhttp.Call createSalesPointAsync(SalesPointRequest body, String authorization, String companyId, String name, final ApiCallback<SalesPointRespose> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createSalesPointValidateBeforeCall(body, authorization, companyId, name, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SalesPointRespose>(){}.getType();
