...
public class AutorizacinDeDepsitosApi {
     ...
     * @param body Información para habilitar / deshabilitar la autorización de depósito (required)
     * @param authorization Header para token (required)
     * @param subscription Es el identificador de la suscripción a esta API. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
    ...
    /**
     * Habilita / Deshabilita la autorización de depósitos (asynchronously)
     * Habilita o deshabilita la autorización de depósitos. Devuelve la información final de la autorización de depósitos del contrato relacionado a la suscripción al terminar.
     * @param body Información para habilitar / deshabilitar la autorización de depósito (required)
     * @param authorization Header para token (required)
     * @param subscription Es el identificador de la suscripción a esta API. (required)
